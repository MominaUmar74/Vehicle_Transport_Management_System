...
\begin{itemize}
    \item Page load time < 3 seconds (95th percentile)
    \item Payment processing < 10 seconds
...
\begin{figure}[!p]
    \centering
    \includegraphics[width=\textwidth,height=0.95\textheight,keepaspectratio]{use.png}
...
\fullpagefigure{DFD Level 2 (1).pdf}{Level 2 Data Flow Diagram}

\subsection{Sequence Diagram}
\fullpagefigure{Sequnce_Diagram_VTMS.png}{Sequence Diagram for Order Processing}
...
\fullpagefigure{aaa.png}{Shipment and Tracking Activity Diagram}
...
\fullpagefigure{as.png}{Component Diagram}
